...
import net.flintloader.libs.moonconfig.core.file.FileConfig;
...
public class DynamicLightsConfig {
	...
	public static final Path CONFIG_FILE_PATH = FlintLoader.getConfigDirectory().toPath().resolve("lambdynlights.toml");
